...
class TestCLIWithMockProject:
    ...
    def test_generate_real_project(self, sample_python_project, temp_project_dir):
    ...
    def test_suggest_real_project(self, sample_python_project):
        ...
        # Should succeed
        assert result.exit_code == 0
        assert "Suggestions" in result.output or "recommendations" in result.output.lower()
